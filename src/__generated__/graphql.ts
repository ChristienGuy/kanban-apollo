...
export type GetProjectQuery = { __typename?: 'Query', project: { __typename: 'Project', title: string, columns: Array<{ __typename: 'Column', title: string, id: string, position: string, project: { __typename: 'Project', id: string }, tasks: Array<{ __typename: 'Task', id: string, title: string, position: string, column: { __typename: 'Column', id: string } }> }> } };
...
export type UpdateTaskMutation = { __typename?: 'Mutation', updateTask?: { __typename: 'Task', id: string, position: string, column: { __typename: 'Column', id: string, project: { __typename: 'Project', id: string } } } | null };
