...
export type GetProjectQuery = { __typename?: 'Query', project: { __typename: 'Project', id: string, title: string, columns: Array<{ __typename: 'Column', title: string, id: string, position: string, tasks: Array<{ __typename: 'Task', id: string, title: string, position: string }> }> } };
